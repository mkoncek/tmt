...
def verbose_debug_quiet(function: Any) -> Any:
...
def force_dry(function: Any) -> Any:
...
def fix(function: Any) -> Any:
    return tmt.options.fix(function)


def name_filter_condition(function: Any) -> Any:
...
def name_filter_condition_long(function: Any) -> Any:
...
def implemented_verified_documented(function: Any) -> Any:
